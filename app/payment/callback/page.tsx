...
const PaymentCallback: React.FC = () => {
  ...
  const orderIdParam = queryParams.get("orderId"); // Extract payment ID
  ...
  useEffect(() => {
    const checkPaymentStatus = async () => {
      if (status === "completed" || status === "paid") {
        ...
        setMessage(
          "فشل الدفع! سيتم تحويلك إلى الصفحة الرئيسية خلال 5 ثوانٍ." +
            "\n" +
            "في حال قمت بإتمام عملية الدفع ولم تكتمل عملية الطلب يرجى التواصل مع الدعم الفني عبر الواتساب."
        );
